...
export default ExpenseOwnerDropdown = ({ users, setPaidBy }) => {
    ...
    return (
        <Animatable.View animation="fadeIn" duration={1000} style={styles.dropdownContainer}>
            <SelectDropdown
                data={userDetails}
                    ...
                    return (
                        <View style={styles.dropdownBtnChildStyle}>
                            ...
                            <View style={styles.dropdownBtnGridColumn2}>
                                <Text style={styles.dropdownBtnTxt}>{selectedItem ? selectedItem.title : 'who paid?'}</Text>
                            </View>
                            <View style={styles.dropdownBtnGridColumn3}>
                                <FontAwesome name="chevron-down" color={'#444'} size={18} style={{ justifyContent: 'flex-end' }} />
                            </View>
                        </View>
                    )
                }}
                ...
                renderCustomizedRowChild={(item, index) => {
                    return (
                        <Animatable.View animation="fadeInDown" duration={500} style={styles.dropdownRowChildStyle}>
                            ...
                            <View style={styles.dropdownRowChildColumn2}>
                                ...
                                <Text style={styles.dropdownRowTxtPhone}>+91-{item.phoneNumber}</Text>
                            </View>
                        </Animatable.View>
                    );
                }}
