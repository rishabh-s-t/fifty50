...
export default Transaction = ({
  ...
  const touchableMessage = {0: 'already paid', 1: 'tap to pay', 2: 'no need to pay'}
        ...
        <View style={styles.billMetaContainer}>
            ...
            <View style={styles.statusContainer}>
                <View style={[styles.billStatus, {backgroundColor: statusColor}]}>
                    <Text style={{fontSize: 10, fontWeight: 'bold', color: '#ffffff'}}>{billStatusMessage}</Text>
                </View>
            </View>
        </View>
        
        <View style={styles.splitAmountContainer}>
            <Text style={{fontSize: 16, marginLeft: '4%', marginTop: '2%'}}>Split into {splitParticipants} (Rs. {splitAmount})</Text>
        </View>

        <View style={{alignItems: 'flex-end', marginRight: '4%'}}>
            <TouchableOpacity disabled={disabled}>
                <View style={{backgroundColor: statusColor, borderRadius: 20, height: 48, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center'}}>
                    <Text style={{color: '#ffffff', fontWeight: 'bold'}}>{touchableMessage[billStatus]}</Text>
                </View>
            </TouchableOpacity>
        </View>
    </View>
